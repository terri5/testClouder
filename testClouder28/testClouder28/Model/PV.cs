    ...
    public class PV : IHBaseModel
    {
        ...
        public BsonDocument LineToBson(string line, string dmac)
        {
            ...
            if (!string.IsNullOrEmpty(dateStr))
            {
                ...
                string url = string.Empty, httpUri = string.Empty, httpMethod = string.Empty, httpVer = string.Empty;
                ...
                if (blnUrl || blnRequest)
                {
                    ...
                    obj.Add(REFERER, url);
                    obj.Add(ConvertUtil.Unique_Key, dmac + date.ToString("yyyyMMddHHmmss") + ip.Replace(".", "") + StringUtil.ConvertBase64(httpUri + url));
